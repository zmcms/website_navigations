	...
	<form class="micro12" id="zmcms_website_navigation_create_link_frm" method="post" enctype="multipart/form-data">
        ...
        <div id="tabcontent_1" class="tabcontent active">
            <label class="micro6">
                ...
                <input class="micro12 mini10 required" type="text" name="name" value="{{$data->name ?? null}}" placeholder="Nazwa">
            </label>
            <label class="micro6">
                <span class="micro12 mini2">Slug</span>
                <input class="micro12 mini10 required" type="text" name="slug" value="{{$data->slug ?? null}}" placeholder="Slug">
            </label>
            <label class="micro12">
                <span class="micro12 mini2">Link</span>
                <input class="micro12 mini10 required" type="text" name="link" value="{{$data->link ?? null}}" placeholder="Link, który prowadzi do niniejszej pozycji">
            </label>
            <label class="micro3">
